...
USB_OTG_STS  USB_OTG_PhyInit         (USB_OTG_CORE_HANDLE * const pdev);
USB_OTG_STS  USB_OTG_SetCurrentMode  (USB_OTG_CORE_HANDLE * const pdev,
    uint8_t mode);
...
uint8_t      USBH_IsEvenFrame (USB_OTG_CORE_HANDLE * const pdev);
