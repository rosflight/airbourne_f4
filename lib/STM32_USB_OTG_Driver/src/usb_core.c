...
* @retval None
*/
static void USB_OTG_EnableCommonInt(volatile USB_OTG_CORE_HANDLE *pdev)
{
...
*/
static USB_OTG_STS USB_OTG_CoreReset(volatile USB_OTG_CORE_HANDLE *pdev)
{
...
* @retval USB_OTG_STS : status
*/
USB_OTG_STS USB_OTG_SelectCore(volatile USB_OTG_CORE_HANDLE *pdev,
...
* @retval USB_OTG_STS : status
*/
USB_OTG_STS USB_OTG_SetCurrentMode(volatile USB_OTG_CORE_HANDLE *pdev , uint8_t mode)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_GUSBCFG_TypeDef  usbcfg;
