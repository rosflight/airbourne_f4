...
#define IS_RCC_PLLSAI_DIVR_VALUE(VALUE)                                                                     \
  (((VALUE) == RCC_PLLSAIDivR_Div2) || ((VALUE) == RCC_PLLSAIDivR_Div4) || ((VALUE) == RCC_PLLSAIDivR_Div8) \
...
#define IS_RCC_SYSCLK_SOURCE(SOURCE)                                                                                  \
  (((SOURCE) == RCC_SYSCLKSource_HSI) || ((SOURCE) == RCC_SYSCLKSource_HSE) || ((SOURCE) == RCC_SYSCLKSource_PLLPCLK) \
...
#endif /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx || STM32F401xx || STM32F410xx || STM32F411xE || \
          STM32F469_479xx */
/**
 * @}
 */
...
#define IS_RCC_GET_IT(IT)                                                                                   \
  (((IT) == RCC_IT_LSIRDY) || ((IT) == RCC_IT_LSERDY) || ((IT) == RCC_IT_HSIRDY) || ((IT) == RCC_IT_HSERDY) \
   || ((IT) == RCC_IT_PLLRDY) || ((IT) == RCC_IT_CSS) || ((IT) == RCC_IT_PLLSAIRDY) || ((IT) == RCC_IT_PLLI2SRDY))
...
#define IS_RCC_RTCCLK_SOURCE(SOURCE)                                                                                   \
  (((SOURCE) == RCC_RTCCLKSource_LSE) || ((SOURCE) == RCC_RTCCLKSource_LSI) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div2) \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div3) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div4)                               \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div5) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div6)                               \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div7) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div8)                               \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div9) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div10)                              \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div11) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div12)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div13) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div14)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div15) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div16)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div17) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div18)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div19) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div20)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div21) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div22)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div23) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div24)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div25) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div26)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div27) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div28)                             \
   || ((SOURCE) == RCC_RTCCLKSource_HSE_Div29) || ((SOURCE) == RCC_RTCCLKSource_HSE_Div30)                             \
...
#define IS_RCC_LPTIM1_SOURCE(SOURCE)                                               \
...
#define IS_RCC_I2SCLK_SOURCE(SOURCE)                                                                                 \
  (((SOURCE) == RCC_I2SCLKSource_PLLI2S) || ((SOURCE) == RCC_I2SCLKSource_Ext) || ((SOURCE) == RCC_I2SCLKSource_PLL) \
...
#define IS_RCC_MCO1DIV(DIV)                                                                                     \
  (((DIV) == RCC_MCO1Div_1) || ((DIV) == RCC_MCO1Div_2) || ((DIV) == RCC_MCO1Div_3) || ((DIV) == RCC_MCO1Div_4) \
   || ((DIV) == RCC_MCO1Div_5))
/**
 * @}
 */
...
#define IS_RCC_MCO2DIV(DIV)                                                                                     \
  (((DIV) == RCC_MCO2Div_1) || ((DIV) == RCC_MCO2Div_2) || ((DIV) == RCC_MCO2Div_3) || ((DIV) == RCC_MCO2Div_4) \
   || ((DIV) == RCC_MCO2Div_5))
/**
 * @}
 */
