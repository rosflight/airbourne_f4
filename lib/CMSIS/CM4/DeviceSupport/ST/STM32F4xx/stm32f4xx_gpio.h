...
#define IS_GPIO_ALL_PERIPH(PERIPH)                                                                                    \
  (((PERIPH) == GPIOA) || ((PERIPH) == GPIOB) || ((PERIPH) == GPIOC) || ((PERIPH) == GPIOD) || ((PERIPH) == GPIOE)    \
   || ((PERIPH) == GPIOF) || ((PERIPH) == GPIOG) || ((PERIPH) == GPIOH) || ((PERIPH) == GPIOI) || ((PERIPH) == GPIOJ) \
   || ((PERIPH) == GPIOK))
...
#define IS_GPIO_MODE(MODE) \
  (((MODE) == GPIO_Mode_IN) || ((MODE) == GPIO_Mode_OUT) || ((MODE) == GPIO_Mode_AF) || ((MODE) == GPIO_Mode_AN))
...
#define IS_GPIO_AF(AF)                                                                                             \
  (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO) || ((AF) == GPIO_AF_TAMPER)      \
   || ((AF) == GPIO_AF_SWJ) || ((AF) == GPIO_AF_TRACE) || ((AF) == GPIO_AF_TIM1) || ((AF) == GPIO_AF_TIM2)         \
   || ((AF) == GPIO_AF_TIM3) || ((AF) == GPIO_AF_TIM4) || ((AF) == GPIO_AF_TIM5) || ((AF) == GPIO_AF_TIM8)         \
   || ((AF) == GPIO_AF_I2C1) || ((AF) == GPIO_AF_I2C2) || ((AF) == GPIO_AF_I2C3) || ((AF) == GPIO_AF_SPI1)         \
   || ((AF) == GPIO_AF_SPI2) || ((AF) == GPIO_AF_TIM13) || ((AF) == GPIO_AF_SPI3) || ((AF) == GPIO_AF_TIM14)       \
   || ((AF) == GPIO_AF_USART1) || ((AF) == GPIO_AF_USART2) || ((AF) == GPIO_AF_USART3) || ((AF) == GPIO_AF_UART4)  \
   || ((AF) == GPIO_AF_UART5) || ((AF) == GPIO_AF_USART6) || ((AF) == GPIO_AF_CAN1) || ((AF) == GPIO_AF_CAN2)      \
   || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS) || ((AF) == GPIO_AF_ETH) || ((AF) == GPIO_AF_OTG_HS_FS) \
   || ((AF) == GPIO_AF_SDIO) || ((AF) == GPIO_AF_DCMI) || ((AF) == GPIO_AF_EVENTOUT) || ((AF) == GPIO_AF_FSMC))
#endif /* STM32F40_41xxx */
...
#define IS_GPIO_AF(AF)                                                                                           \
  (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO) || ((AF) == GPIO_AF_TAMPER)    \
   ...
   || ((AF) == GPIO_AF_I2C1) || ((AF) == GPIO_AF_I2C2) || ((AF) == GPIO_AF_I2C3) || ((AF) == GPIO_AF_SPI1)       \
   || ((AF) == GPIO_AF_SPI2) || ((AF) == GPIO_AF_TIM13) || ((AF) == GPIO_AF_SPI3) || ((AF) == GPIO_AF_TIM14)     \
   || ((AF) == GPIO_AF_USART1) || ((AF) == GPIO_AF_USART2) || ((AF) == GPIO_AF_SDIO) || ((AF) == GPIO_AF_USART6) \
   || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS) || ((AF) == GPIO_AF_EVENTOUT) || ((AF) == GPIO_AF_SPI4))
#endif /* STM32F401xx */
...
#define IS_GPIO_AF(AF)                                                                                             \
  (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO) || ((AF) == GPIO_AF_TAMPER)      \
   ...
   || ((AF) == GPIO_AF_UART5) || ((AF) == GPIO_AF_USART6) || ((AF) == GPIO_AF_CAN1) || ((AF) == GPIO_AF_CAN2)      \
   || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS) || ((AF) == GPIO_AF_ETH) || ((AF) == GPIO_AF_OTG_HS_FS) \
   || ((AF) == GPIO_AF_SDIO) || ((AF) == GPIO_AF_DCMI) || ((AF) == GPIO_AF_EVENTOUT) || ((AF) == GPIO_AF_SPI4)     \
   || ((AF) == GPIO_AF_SPI5) || ((AF) == GPIO_AF_SPI6) || ((AF) == GPIO_AF_UART7) || ((AF) == GPIO_AF_UART8)       \
