...
#include "stm32f4xx.h"
  ...
  typedef struct
  {
    ...
    uint32_t FSMC_DataSetupTime; /*!< Defines the number of HCLK cycles to configure
                                      ...
                                      @note This parameter is used for SRAMs, ROMs and asynchronous multiplexed NOR
                                    Flash memories. */
...
#define IS_FSMC_MEMORY(MEMORY) \
  (((MEMORY) == FSMC_MemoryType_SRAM) || ((MEMORY) == FSMC_MemoryType_PSRAM) || ((MEMORY) == FSMC_MemoryType_NOR))
  /**
   * @}
   */
...
#define IS_FSMC_WAIT_SIGNAL_ACTIVE(ACTIVE) \
  (((ACTIVE) == FSMC_WaitSignalActive_BeforeWaitState) || ((ACTIVE) == FSMC_WaitSignalActive_DuringWaitState))
/**
 * @}
 */
