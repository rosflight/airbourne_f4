...
#define IS_SPI_ALL_PERIPH(PERIPH)                                                                             \
  (((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == SPI4) || ((PERIPH) == SPI5) \
   || ((PERIPH) == SPI6))

#define IS_SPI_ALL_PERIPH_EXT(PERIPH)                                                                         \
  (((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == SPI4) || ((PERIPH) == SPI5) \
   || ((PERIPH) == SPI6) || ((PERIPH) == I2S2ext) || ((PERIPH) == I2S3ext))
...
#define IS_I2S_STANDARD(STANDARD)                                                                                \
  (((STANDARD) == I2S_Standard_Phillips) || ((STANDARD) == I2S_Standard_MSB) || ((STANDARD) == I2S_Standard_LSB) \
   || ((STANDARD) == I2S_Standard_PCMShort) || ((STANDARD) == I2S_Standard_PCMLong))
  /**
   * @}
   */
...
#define IS_I2S_DATA_FORMAT(FORMAT)                                                                                  \
  (((FORMAT) == I2S_DataFormat_16b) || ((FORMAT) == I2S_DataFormat_16bextended) || ((FORMAT) == I2S_DataFormat_24b) \
...
#define IS_SPI_I2S_GET_IT(IT)                                                                                \
  (((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_TXE) || ((IT) == SPI_IT_CRCERR) || ((IT) == SPI_IT_MODF) \
