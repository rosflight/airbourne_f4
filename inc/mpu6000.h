/**
 * MPU6000 sensor driver for OpenPilot REVO
 *
 * Adapted from https://github.com/jihlein/AQ32Plus/blob/master/src/sensors/mpu6000.h
 * 			and https://github.com/superjax/airbourne/blob/f4/f4/include/mpu6000_spi.h
 * @author len0rd
 * @since 2017-08-14
 */
#ifndef MPU6000_H
...
public:
  ...
  void read_sensors(float (&accel_data)[3], float (&gyro_data)[3], float *temp_data, uint64_t *stamp_us);
  void set_new_data();
  inline bool new_data() { return new_data_; }
};

extern MPU6000* IMU_Ptr;
